...
module RbConfig
  RUBY_VERSION.start_with?("3.0.") or
    raise "ruby lib version (3.0.6) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["MINOR"] = "0"
  CONFIG["TEENY"] = "6"
  CONFIG["PATCHLEVEL"] = "216"
  CONFIG["INSTALL"] = '/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/ec2-user/.rvm/rubies/ruby-3.0.6")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/ec2-user/.rvm/rubies/ruby-3.0.6' '--disable-install-doc' '--enable-shared'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/home/ec2-user/.rvm/rubies/ruby-3.0.6"
  ...
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc (GCC) 7.3.1 20180712 (Red Hat 7.3.1-17)\nCopyright (C) 2017 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  CONFIG["CC_VERSION"] = "$(CC) --version"
  CONFIG["MJIT_CC"] = "/bin/gcc"
  CONFIG["CSRCFLAG"] = ""
  CONFIG["COUTFLAG"] = "-o "
  CONFIG["OUTFLAG"] = "-o "
